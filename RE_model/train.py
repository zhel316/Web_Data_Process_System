...
def train_and_evaluate(model, train_data, val_data, optimizer, scheduler, params, metric_labels, model_dir,
                       restore_file=None):
...
def CNN(data_loader, params):
    ...
    if params.optim_method == 'sgd':
        ...
        optimizer = optim.Adam(model.parameters(), lr=params.learning_rate, betas=(0.9, 0.999),
                               weight_decay=params.weight_decay)
