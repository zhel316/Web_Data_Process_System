...
from R_BERT.model import RBERT
#from model import RBERT
from R_BERT.utils import get_label, init_logger, load_tokenizer
...
def predict_re(sentence):
    #
    init_logger()
    parser = argparse.ArgumentParser()
    parser.add_argument("--model_dir", default="./R_BERT/model", type=str, help="Path to save, load model")
    ...
    #parser.add_argument("--pre_data", default=sentence)
    ...
    dataset = convert_input_file_to_tensor_dataset(pred_config, args,sentence)
...
if __name__ == "__main__":
    sentence = 'A little <e1> girl </e1> finds a lost shoe with the help of her imaginary dinosaur <e2> companion </e2>.'
    predict_re(sentence)
    #init_logger()
    #parser = argparse.ArgumentParser()
'''
